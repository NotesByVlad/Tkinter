...
class GameApp:
	def __init__(self, root):
		...
		# Button images
		self.rock_button_img = PhotoImage(file="images/rock_button.png")
		self.paper_button_img = PhotoImage(file="images/paper_button.png")
		self.scissor_button_img = PhotoImage(file="images/scissors_button.png")
		...
		self.rock_button = Button(root,image=self.rock_button_img,width=80, height=97,bg="#262626",
		...
		self.paper_button = Button(root,image=self.paper_button_img,width=80, height=97,bg="#262626",
		...
		self.scissors_button = Button(root,image=self.scissor_button_img,width=80, height=97,bg="#262626",
